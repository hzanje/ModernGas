...
public interface OrderService {
    ...
    Page<com.moderngas.pojo.admin.OrderDto> getAllOrderListForAdmin(Pageable pageable, String status, String search, String filter) throws JsonProcessingException;
}
